...
function fetchAndDisplayBusDepartures() {
  fetch(
    ...
    .then((jsonData) => {
      ...
      let html = "";
      let counter = 0;
      setTimeout(fetchAndDisplayBusDepartures, 60000); // Fetch every 1 minutes
